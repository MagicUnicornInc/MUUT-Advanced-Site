    ...
    >
      <div className="container nav-container">
        ...
        <div className={`nav-links ${isMenuOpen ? 'active' : ''}`} aria-label="Navigation links">
          ...
          <Link to="/building-in-public" className={location.pathname === '/building-in-public' ? 'active' : ''} aria-label="Building In Public">
            Building In Public
          </Link>
          <Link to="/social-hub" className={location.pathname === '/social-hub' ? 'active' : ''} aria-label="Social Hub">
            Social Hub
          </Link>
